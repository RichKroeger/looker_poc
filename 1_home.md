...
<div style="background: #8b7da7;">
  <p style="background: #20a5de; font-weight: 300; color: #fff; padding: 15px 0; font-size: 20px;"><span style="font-weight: 400;">Start Date:</span> 10/17/2017 | <span style="font-weight: 400;">End Date:</span> 10/27/2017 </p>
</div>
...
<div style="width: 100%; clear: both; float: left; padding-top: 40px; padding-bottom: 40px;">
  <div style="width: 85%; margin: auto;">
    ...
    <div style="padding-left: 20px;float:left; width: 50%;">
      <img style="border-radius: 50%; width: 100px; float:left;" src="https://media.licdn.com/media-proxy/ext?w=800&h=800&hash=WfMXP93wW7UhJsMDqjC6MSACRuA%3D&ora=1%2CaFBCTXdkRmpGL2lvQUFBPQ%2CxAVta9Er0Vinkhwfjw8177yE41y87UNCVordEGXyD3u0qYrdfyK8LMHcfbCjuV9ALisclAdkLPKgFWa3D5O_eIK5LNwl2MKxIY27dA4BYBI3iSdF_NQ8">
      <div style="float:left; text-align: left; padding-left: 15px; padding-top: 15px;">
        <p><span style="font-size: 16px;">Mgr of BI at Zotos</span><br>
        <span style="font-weight: 300;">Rich Kroeger<br>
        rkroeger@zotos.com</span></p>
      </div>
    </div>
    ...
    <div style="padding-left: 40px;float:left; width: 50%;">
      <img style="border-radius: 50%; width: 100px; float:left;" src="https://wwwstatic.lookercdn.com/people/team/lara_tromba_v0002.png">
      <div style="float:left; text-align: left; padding-left: 15px; padding-top: 15px;">
        <p><span style="font-size: 16px;">Analyst</span><br>
        <span style="font-weight: 300;">Lara Tromba<br>
        lara.tromba@looker.com</span></p>
      </div>
    </div>
